      ...
      <div class="col-xl-8 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block "><img src="{{asset('public/admin_master/img/logo_pln.jpg')}}" style="height: 500px;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <br><br>
                  ...
                  <div class="text-center">
                  <label ></label>
                    <a class="" style="color: black;" href="{{route('register')}}"><b>Register</b></a>
                  </div>
                </div>
              </div>
            </div>
